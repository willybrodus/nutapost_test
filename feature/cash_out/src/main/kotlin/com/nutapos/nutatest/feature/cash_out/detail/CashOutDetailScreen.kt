...
fun CashOutDetailScreen(
  ...
  Scaffold(
    ...
    Column(
      ...
      DetailItem(label = stringResource(id = R.string.label_amount), value = "Rp 50.000")
      DetailItem(
        label = stringResource(id = R.string.label_outcome_type),
        value = "Pengeluaran (diambil dari modal)"
      )
