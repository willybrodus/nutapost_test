...
@Composable
fun SourceOutcomeTypeSelectionBottomSheet(
  sheetState: SheetState,
  onDismiss: () -> Unit,
  onSelected: (SourceOutcomeType) -> Unit,
  initialSelected: SourceOutcomeType? = null
) {
  val options = listOf(SourceOutcomeType.Income, SourceOutcomeType.Modal)
  ...
  ModalBottomSheet(
    ...
    NutaTestBottomSheet(
      title = "Pilih Sumber Pengeluaran",
      onDismissRequest = onDismiss
    ) {
      Column {
...
@Composable
private fun SoureOutcomeTypeSelectionBottomSheetPreview() {
  NutaTestTheme {
    NutaTestBottomSheet(
      ...
      val options = listOf(SourceOutcomeType.Income, SourceOutcomeType.Modal)
      var selectedOption by remember { mutableStateOf<SourceOutcomeType?>(SourceOutcomeType.Income) }
      Column {
        options.forEachIndexed { index, option ->
          Row(
            modifier = Modifier
